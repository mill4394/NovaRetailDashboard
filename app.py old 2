...
top_customers["CustomerLabel"] = "#" + top_customers["CustomerID"]
...
segment_summary_display["Assessment"] = segment_summary_display[
    ...
    {
        "Potentially At Risk": "⚠️ Potentially At Risk",
        "Monitor / Stable": "✓ Monitor / Stable",
    }
)
...
def highlight_at_risk(row):
    ...
    is_at_risk = "Potentially At Risk" in str(row["Assessment"])
    if is_at_risk:
        return [
